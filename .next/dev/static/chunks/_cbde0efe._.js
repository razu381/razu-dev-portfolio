...
"[project]/hooks/use-text-stroke-observer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>__TURBOPACK__default__export__,
    "useTextStrokeObserver",
    ()=>useTextStrokeObserver
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
function useTextStrokeObserver() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useTextStrokeObserver.useEffect": ()=>{
            // Get all text-stroke elements
            const textStrokeElements = document.querySelectorAll('.text-stroke, .text-stroke-accent, .text-stroke-faint');
            if (textStrokeElements.length === 0) return;
            // Create intersection observer
            const observer = new IntersectionObserver({
                "useTextStrokeObserver.useEffect": (entries)=>{
                    entries.forEach({
                        "useTextStrokeObserver.useEffect": (entry)=>{
                            const element = entry.target;
                            if (entry.isIntersecting) {
                                // When element enters viewport, add filled class
                                element.classList.add('text-stroke-filled');
                            } else {
                                // When element leaves viewport, remove filled class
                                element.classList.remove('text-stroke-filled');
                            }
                        }
                    }["useTextStrokeObserver.useEffect"]);
                }
            ...
            // Observe all text-stroke elements
            textStrokeElements.forEach({
                "useTextStrokeObserver.useEffect": (element)=>{
                    observer.observe(element);
                }
            }["useTextStrokeObserver.useEffect"]);
            observerRef.current = observer;
            // Handle scroll to trigger hover when cursor is over text after scroll stops
            const handleScroll = {
                "useTextStrokeObserver.useEffect.handleScroll": ()=>{
                    // Clear previous timeout
                    if (scrollTimeoutRef.current) {
                        clearTimeout(scrollTimeoutRef.current);
                    }
                    // Wait for scroll to stop, then check what's under cursor
                    scrollTimeoutRef.current = setTimeout({
                        "useTextStrokeObserver.useEffect.handleScroll": ()=>{
                            const elementUnderCursor = document.elementFromPoint(mousePosRef.current.x, mousePosRef.current.y);
                            if (elementUnderCursor) {
                                // Check if the element or its parent is a text-stroke element
                                const textStrokeElement = elementUnderCursor.closest('.text-stroke, .text-stroke-accent, .text-stroke-faint');
                                if (textStrokeElement) {
                                    // Trigger hover effect
                                    textStrokeElement.classList.add('text-stroke-filled');
                                }
                            }
                        }
                    }["useTextStrokeObserver.useEffect.handleScroll"], 100); // Wait 100ms after scroll stops
                }
            }["useTextStrokeObserver.useEffect.handleScroll"];
            // Track mouse position
            const handleMouseMove = {
                "useTextStrokeObserver.useEffect.handleMouseMove": (e)=>{
                    mousePosRef.current = {
                        x: e.clientX,
                        y: e.clientY
                    };
                }
            }["useTextStrokeObserver.useEffect.handleMouseMove"];
...
_s(useTextStrokeObserver, "Ia/5aDSrlSMnWiY1NlScXAdsplU=");
const __TURBOPACK__default__export__ = useTextStrokeObserver;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$text$2d$stroke$2d$observer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-text-stroke-observer.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
...
;
;
function TextStrokeObserver() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$text$2d$stroke$2d$observer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTextStrokeObserver"])();
    return null;
}
_s(TextStrokeObserver, "4gmtD1kDjtodr6CR/l5VNTjAf/c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$text$2d$stroke$2d$observer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTextStrokeObserver"]
    ];
});
_c = TextStrokeObserver;
function Providers({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipProvider"], {
            children: [
                children,
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TextStrokeObserver, {}, void 0, false, {
...
_c1 = Providers;
var _c, _c1;
__turbopack_context__.k.register(_c, "TextStrokeObserver");
...
//# sourceMappingURL=_cbde0efe._.js.map